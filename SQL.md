...
CAST - это оператор, который используется для изменения типа данных значения столбца или выражения в другой тип данных.

CAST может использоваться в различных случаях, например, для:
