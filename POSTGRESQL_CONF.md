...
Блоки памяти:  B  = байты            Единицы времени:   us  = микросекунды
               kB = килобайты                           ms  = милисекунды
...
<b><em>Изменения требуют перезапуска сервера</em></b>
...
#listen_addresses = 'localhost'		# какой IP-адрес(а) прослушивать 
                                    (список адресов, разделенный запятыми, 
